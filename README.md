...
| `InfiniCube` |
| `DrivingSphere` |
| `Doe-1` | [![arXiv](https://img.shields.io/badge/arXiv-2412.09627-b31b1b?style=flat-square&logo=arxiv)](https://arxiv.org/abs/2412.09627)<br>Doe-1: Closed-Loop Autonomous Driving with Large World Model | arXiv 2024 |  |
| `DiST-4D` |
| `UniFuture` |
||
...
| `OccSora` |  | arXiv 2024 |
| `DOME` |  | arXiv 2024 |
| `DFIT-OccWorld` |  | arXiv 2024 |
| `LOPR` | 
| `GaussianAD` | 
| `FSF-Net` | 
| `Drive-OccWorld` | 
| `RenderWorld` |  | ICRA 2025 |
| `EfficientOCF` |  | CVPR 2025 |
| `UniOcc` |  | arXiv 2025 |
| `Occ-LLM` | 
| `T3Former` | 
| `COME` |
